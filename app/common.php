...
if (!function_exists('__url')) {
     ...
     * @return string
     */
    function __url(string $url = '', array $vars = [], bool $suffix = true, bool $domain = false)
    {
...
if (!function_exists('xdebug')) {
     ...
     * @param string|null $suffix 文件后缀名
     * @param bool $force
     * @param null $file
     * @deprecated 不建议使用，建议直接使用框架自带的log组件
     */
    function xdebug($data, string $type = 'xdebug', string $suffix = null, bool $force = false, $file = null)
    {
