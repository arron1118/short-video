...
class Node extends AdminController
{
    ...
    public function refreshNode($force = 0): void
    {
        ...
        empty($nodeList) && $this->error(lang('There are no system nodes that need to be updated'));
        ...
        try {
            ...
            $this->error(lang('Node update failed'));
        }
        $this->success(lang('Node update successful'));
    }
