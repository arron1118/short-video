...
trait JumpTrait
{
     ...
     */
    protected function success($msg = '', $data = '', string $url = null, int $wait = 3, array $header = []): void
    {
     ...
     * @throws HttpResponseException
     */
    protected function error($msg = '', $data = '', string $url = null, int $wait = 3, array $header = []): void
    {
        if (is_null($url)) {
