define(["jquery", "easy-admin", "treetable"], function ($, ea) {
    ...
    let init = {
        ...
        index_url: 'share.cate/index',
        add_url: 'share.cate/add',
        edit_url: 'share.cate/edit',
        delete_url: 'share.cate/delete',
        export_url: 'share.cate/export',
        modify_url: 'share.cate/modify',
    };
    ...
    let Controller = {
        ...
        index: function () {
            ...
            $('body').on('click', '[data-treetable-delete]', function () {
                let tableId = $(this).attr('data-treetable-delete'),
