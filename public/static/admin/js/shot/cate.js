define(["jquery", "easy-admin", "treetable"], function ($, ea) {
    ...
    let init = {
        ...
        index_url: 'shot.cate/index',
        add_url: 'shot.cate/add',
        edit_url: 'shot.cate/edit',
        delete_url: 'shot.cate/delete',
        export_url: 'shot.cate/export',
        modify_url: 'shot.cate/modify',
    };
